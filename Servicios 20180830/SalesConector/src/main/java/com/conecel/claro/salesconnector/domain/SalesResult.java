...
@Entity
@Cacheable(false)
@JsonPropertyOrder({ "order", "description", "loggedDate", "officceId", "officce", "seller", "customerId", "customer", "product", "productValue", "activationDate", "status", "paymentType", "financialInstitution", "account", "regularizedUser" })
