...
@Entity
@Cacheable(false)
@JsonPropertyOrder({ "orderId", "customerId", "activationDate", "loggedUser", "paymentType", "financialInstitution", "officceId", "officce", "days", "status", "reason", "observation", "regularizedUser" })
